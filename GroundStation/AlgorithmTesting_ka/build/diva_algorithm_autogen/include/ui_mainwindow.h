...
public:
    ...
    QLabel *label_Result_text2;
    QLabel *label_Result_text_title;
    QMenuBar *menubar;
...
""));
        ...
        label_Result_text2 = new QLabel(centralwidget);
        label_Result_text2->setObjectName(QStringLiteral("label_Result_text2"));
        label_Result_text2->setGeometry(QRect(360, 570, 911, 91));
        QPalette palette4;
        ...
        label_Result_text2->setPalette(palette4);
        QFont font1;
        ...
        label_Result_text2->setFont(font1);
        label_Result_text2->setStyleSheet(QLatin1String("background-color: rgb(255, 255, 255);\n"
"color : rgb(0, 0, 0);"));
        label_Result_text2->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
        label_Result_text2->setTextInteractionFlags(Qt::LinksAccessibleByMouse);
        label_Result_text_title = new QLabel(centralwidget);
        label_Result_text_title->setObjectName(QStringLiteral("label_Result_text_title"));
        label_Result_text_title->setGeometry(QRect(360, 550, 911, 21));
        QPalette palette5;
        ...
        QBrush brush19(QColor(0, 0, 128, 128));
        ...
        label_Result_text_title->setPalette(palette5);
        label_Result_text_title->setStyleSheet(QLatin1String("background-color: rgb(255, 255, 255);\n"
"color : rgb(0, 0, 128);"));
        label_Result_text_title->setTextInteractionFlags(Qt::LinksAccessibleByMouse);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_Result_text2->setText(QApplication::translate("MainWindow", "TextLabel", Q_NULLPTR));
        label_Result_text_title->setText(QApplication::translate("MainWindow", "Result", Q_NULLPTR));
